...
const page = async({ params }: { params: Promise<{ slug: string }>}) => {
  ...
  console.log(slug)
  return (
    <div className='flex flex-col md:h-screen items-center justify-center bg-emerald-100 dark:bg-background'>
      <div className='flex flex-col gap-8 bg-white dark:bg-card-primary w-full md:max-w-3xl p-4 rounded-2xl shadow-lg overflow-y-auto'>
